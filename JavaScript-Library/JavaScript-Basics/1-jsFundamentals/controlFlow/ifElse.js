...
/*
Bronze:
Write if else statement that checks your name;
If it is your name, console log <name>
If the name does not match, console.log 'Hello, what is your name?'

Silver 
If iit is your name, console log 'Hello, my name is <name>'

Gold:
If it is your name console log "hello, is your name <name here>?"
*/
...
let age = 33;
// you want to start with your hughest condition and work your way down
if(age<=17) {
